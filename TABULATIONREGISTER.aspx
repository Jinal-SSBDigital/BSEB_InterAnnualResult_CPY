...
<body class="p-2">
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txt_rollcode" runat="server" CssClass="form-control" Placeholder="Rollcode"></asp:TextBox>
        <asp:TextBox ID="txt_rollno" runat="server" CssClass="form-control" Placeholder="Rollno"></asp:TextBox>
                    ...
                    <div class="colleagename">
                        <table class="noborder-table" style="width: 100%; border-collapse: collapse; font-family: 'Mangal', 'Nirmala UI', Arial, sans-serif;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-size: 16px;">
                                    <span><b>इंटरमीडिएट वार्षिक परीक्षा , 2026</b></span>
                                    <span style="padding: 0 20px;"><b>INTERMEDIATE ANNUAL EXAMINATION ,2026</b></span>
                                </td>
