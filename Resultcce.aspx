<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Resultcce.aspx.cs" Inherits="Resultcce" %>
        ...
        <center>
            <div style="margin-top: 20px; display: flex; justify-content: center; gap: 10px;">
                <input
                    type="button"
                    value="PRINT"
                    class="noprint btn btn-success"
                    onclick="printDiv('pagewrap')"
                    style="width: 100px; cursor: pointer;" />
                <asp:Button
                    ID="btnBack" runat="server" Text="Back" OnClick="btnBack_Click" CssClass="btn btn-success noprint"
                    Style="width: 100px; cursor: pointer;" />
            ...
            <%-- <div style="margin-top: 50px">
                <asp:Button Style="display: block; width: 100px; cursor: pointer; float: right; margin-right: 54px;" />
            ...
            <div class="page-container" id="pagewrap" style="padding: 10px">
                ...
                %>
                <table style="width: 100%;font-size: 15px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            <table style="width: 100%;" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="border: solid 1px #000; text-align: center;">
                                        <img src="images/bseorissa-logo-w.png" style="width: 70px;" alt="" />
                                    </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" cellspacing="0" cellpadding="0">
                                ...
                                %>
                                <tr>
                                    <td colspan="9" style="border: solid 1px #000; padding: 5px; border-top: none; font-size: 14px; font-weight: bold; font-family: arial;">1. अनिवार्य (Compulsory)</td>
                                </tr>
                                ...
                                <tr class="text_center">
                                    ...
                                    <td><% Response.Write(dr1["CCEMarks"]); %></td>
                                ...
                                %>
                                <tr>
                                    <td colspan="9" style="border: solid 1px #000; padding: 5px; border-top: none; font-size: 14px; font-weight: bold; font-family: arial;">2. ऐच्छिक (Elective)</td>
                                </tr>
                                ...
                                <tr class="text_center">
                                    ...
                                    <td><% Response.Write(dr2["CCEMarks"]); %></td>
                                ...
                                %>
                                <tr>
                                    <td colspan="9" style="border: solid 1px #000; padding: 5px; border-top: none; font-size: 14px; font-weight: bold; font-family: arial;">3. अतिरिक्त Additional</td>
                                </tr>
                                ...
                                <tr class="text_center">
                                    ...
                                    <td><% Response.Write(dr3["CCEMarks"]); %></td>
                                ...
                                %>
                                <tr>
                                    <td colspan="9" style="border: solid 1px #000; padding: 5px; border-top: none; font-size: 14px; font-weight: bold; font-family: arial;">Vocational Trade</td>
                                </tr>
                                ...
                                <tr class="text_center">
                                    ...
                                    <td><% Response.Write(dr4["CCEMarks"]); %></td>
                ...
                <table>
                    ...
                    <tr>
                        <td style="float: right; border: none; font-size: 7px;">SSBD</td>
